...
export function Task({ id, name, completed, onEditTask, onRemoveTask, onCompleteTask}) {
    ...
    return (
        ...
        <div key={id} className="tasks__items-row">
            <div className="checkbox">
                <input onChange={onChangeCheckBox} id={`taks-${id}`} type="checkbox" checked={completed}/>
                <label htmlFor={`taks-${id}`}>
            ...
            <div className="tasks__items-row-actions">
                ...
                <div onClick={() => onEditTask(id, name)}>
